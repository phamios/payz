(function() {
            ...
            c.onload = function() {
                ...
                if (4 == c.readyState) {
                    try {
                        ...
                        a.optOut ? (J(63), Qc("", "$OPT_OUT", 31536E6)) : a.clientId ? Qc(a.clientId, a.securityToken, 31536E6) : (J(64), Qc("", "$ERROR", 864E5))
                    } catch (e) {
                        J(65),
                            Qc("", "$ERROR", 864E5)
                    }
    ...
    var oc = function() {
        ...
        ge = function(a, b, c) {
            1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j58", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(oc() + "/collect", a.join("&"),
                ua))
        };
    var h = function(a) {
        ...
        na = function(a, b, c) {
            if (!a || 1 > a.length) J(12);
                ...
                for (var d = [], e = 0; e < a.length; e++) {
                    ...
                    var l = ca.shift();
                    ("GA1" == l ||
                        "1" == l) && 1 < ca.length ? (g = ca.shift().split("-"), 1 == g.length && (g[1] = "1"), g[0] *= 1, g[1] *= 1, ca = {
                        H: g,
                        s: ca.join(".")
                    }) : ca = kd.test(g) ? {
                        H: [0, 0],
            ...
            if (a.get(Hd)) a: if (c = a.get(cc), d = E(M.location[c ? "href" : "search"], "_ga"))
                if (a.get(bc))
                    if (c = d.indexOf("."), -1 == c) J(22);
                        ...
                        g = g.substring(c + 1);
                        if ("1" == e) {
                            if (c = g, d != Ic(c, 0) && d != Ic(c, -1) && d != Ic(c, -2) && d != pa(c, 0) && d != pa(c, -1) &&
                                d != pa(c, -2)) {
                                J(23);
                                break a
                            }
